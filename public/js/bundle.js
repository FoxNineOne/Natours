    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Settings updated!");
          }
          _context.n = 3;
          break;
        case 2:
