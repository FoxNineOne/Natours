...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: "Acceptable difficulty values : easy / medium / difficult",
      },
    },
    ratingsAverage: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // This keyword only works with current doc when creating docs, not updating.
...
// Embedding - not ideal for updating , not future prood
...
// tourSchema.pre("save", function (next) {
//   console.log("Saving document lad");
//   next();
// });
